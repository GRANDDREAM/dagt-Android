package com.grandream.dagt.fragment.help;
...
public class FragmentExchangeConroller {
    ...
    public static int getStatuBar() {
        ...
        try {
            ...
            sbar = BaseFragmentActivity.getInstance().getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
        return sbar;
