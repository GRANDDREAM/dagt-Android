...
import com.grandream.dagt.ui.pulltorefresh.callback.IFooterCallBack;
import com.grandream.dagt.ui.pulltorefresh.callback.IHeaderCallBack;
import com.grandream.dagt.ui.pulltorefresh.listener.OnBottomLoadMoreTime;
import com.grandream.dagt.ui.pulltorefresh.listener.OnTopRefreshTime;
...
public class XRefreshView extends LinearLayout {
    ...
    private void addFooterView(ViewTreeObserver.OnGlobalLayoutListener listener) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mHolder.hasHeaderPullDown()) {
                    //mHolder.mOffsetY > mHeaderViewHeight/2  设置下拉触发刷新的高度
                    if (mEnablePullRefresh && !mStopingRefresh && !mPullRefreshing && mHolder.mOffsetY > mHeaderViewHeight/3) {
